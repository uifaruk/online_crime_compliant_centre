...
//profession
$hob=implode(",",$hob); //takes array of string and join them using delimiter
//image
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td>
					Business<input value="Business" type="checkbox" name="hob[]"/>
					Government Employee<input value="Government_Employee" type="checkbox" name="hob[]"/>					
