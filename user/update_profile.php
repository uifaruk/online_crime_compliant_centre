	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					Business<input value="Business" <?php if(in_array("Business",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					Government Employee<input value="Government_Employee" <?php if(in_array("Government_Employee",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
